...
namespace TouchScript.InputSources
{
    ...
    public sealed class TuioInput : InputSource
    {
        ...
        public Vector3 xyzPosition = new Vector3(0, 0, 0);
        ...
        private void OnCursorAdded(object sender, TuioCursorEventArgs e)
        {
            ...
            lock (this)
            {
                ...
                var xPos = (0.5f) * Mathf.Sin((float) lat) * Mathf.Cos((float) lon);
                var yPos = (0.5f) * Mathf.Cos((float) lat);
                var zPos = (0.5f) * Mathf.Sin((float) lat) * Mathf.Sin((float) lon);
        ...
        private void OnCursorRemoved(object sender, TuioCursorEventArgs e)
        {
            ...
            lock (this)
            {
                ...
                xyzPosition = new Vector3(100.0f, 100.0f, 100.0f);
